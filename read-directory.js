...
const buildIndexes = (items) => {
  ...
  items.forEach((item,i)=>{
    const { filename:fil, parentDirs:dir, depth, isDirectory,type, tags:tgs } = item
  ...
  return { items, tags, types, directories, filenames, depths, inode:{directory:dirs, file:files } }
}
